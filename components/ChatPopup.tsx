...
const ChatPopup: React.FC<ChatPopupProps> = ({ username }) => {
  ...
  useEffect(() => {
    // Open the chat window automatically after 3 seconds
  ...
  return (
    <>
      {isOpen && (
        <div className="fixed bottom-5 right-5 w-[25vw] h-[25vh] min-w-[300px] min-h-[400px] bg-white border border-gray-300 flex flex-col shadow-lg">
